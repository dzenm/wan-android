...
public final class TabLayoutMediator {
    ...
    public void attach() {
        ...
        mOnTabSelectedListener = new ViewPagerOnTabSelectedListener();
    ...
    class TabLayoutOnPageChangeCallback extends ViewPager2.OnPageChangeCallback {
        ...
        private Method sSetScrollPosition;
        private Method sSelectTab;
        ...
        @SuppressWarnings("WeakerAccess")
        void setScrollPosition(TabLayout tabLayout, int position, float positionOffset,
        ...
        @SuppressWarnings("WeakerAccess")
        void selectTab(TabLayout tabLayout, TabLayout.Tab tab, boolean updateIndicator) {
            try {
                if (sSelectTab != null) {
        ...
        private void throwMethodNotFound(String method) {
            throw new IllegalStateException("Method " + method + " not found");
        }

        private void throwInvokeFailed(String method) {
