...
public class CheckUpdate {
    ...
    public static CheckUpdate with(Activity activity) {
        sActivity = activity;
        return Instance.INSTANCE;
    }
     ...
     * @return
     */
    public CheckUpdate showUpdateDialog(final String downloadUrl) {
     ...
     * @return
     */
    public CheckUpdate startUpdate(String downloadUrl) {
